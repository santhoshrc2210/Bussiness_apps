...
#http://www.codeskulptor.org/#user47_r55bhigAAe_25.py
import simplegui
import random
...
def draw(canvas):
    ...
    canvas.draw_text('Jai Santhoshi Ma!', [10,170], 15, "Black")
    ...
    for i in range(a):
        ...
        canvas.draw_text('Paid Amount: '+str(paid_amount), [625,740], 15, "Black")
        balance=grand_total-paid_amount
        canvas.draw_text('Balance '+str(balance), [625,755], 15, "Black")
